...
public class BooksServiceTests
{
    ...
    [InlineAutoData(2)]
    [InlineAutoData(3)]
    public async Task GetBookByIdTheory_ReturnsBookDTO_WhenBookExists(int testBookId, Book bookFromRepository, BookDTO expectedBookDto)
    {

    // Arrange
    bookFromRepository.Id = testBookId;
    expectedBookDto.Id = testBookId;

    var repository = Substitute.For<IBooksRepository>();
